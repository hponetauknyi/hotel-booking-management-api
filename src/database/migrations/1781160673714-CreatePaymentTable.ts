...
export class CreatePaymentTable1781160673714 implements MigrationInterface {
  name = 'CreatePaymentTable1781160673714';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."payments_currency_enum" AS ENUM('USD', 'EUR', 'GBP', 'SGD', 'THB', 'MMK')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."payments_status_enum" AS ENUM('PENDING', 'COMPLETED', 'FAILED', 'REFUNDED', 'REFUND_PENDING', 'REFUND_FAILED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_d703f4d1bf3e48dbaa5948e03d" ON "payments" ("deletedAt") `,
    );
    await queryRunner.query(
      `ALTER TABLE "bookings" ADD "deletedAt" TIMESTAMP WITH TIME ZONE`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_1481cb05f929015e6bbb257c25" ON "bookings" ("deletedAt") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_1481cb05f929015e6bbb257c25"`,
    );
    await queryRunner.query(`ALTER TABLE "bookings" DROP COLUMN "deletedAt"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d703f4d1bf3e48dbaa5948e03d"`,
    );
